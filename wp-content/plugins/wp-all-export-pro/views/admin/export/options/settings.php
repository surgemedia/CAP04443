					...
					<table class="form-table" style="max-width:none;">
						<tr>
							<td colspan="3">																									
								...
								<?php if ($post['export_to'] == 'xml'): ?>					
								<div class="input" style="margin:5px 0px;">
									<label for="main_xml_tag" style="width: 135px;"><?php _e('Main XML Tag:','wp_all_export_plugin');?></label> 
									<input type="text" name="main_xml_tag" style="vertical-align:middle; background:#fff !important;" value="<?php echo esc_attr($post['main_xml_tag']) ?>" />														
								</div>
								<div class="input" style="margin:5px 0px;">
									<label for="record_xml_tag" style="width: 135px;"><?php _e('Single Record XML Tag:','wp_all_export_plugin');?></label> 
									<input type="text" name="record_xml_tag" style="vertical-align:middle; background:#fff !important;" value="<?php echo esc_attr($post['record_xml_tag']) ?>" />														
								</div>
								<?php endif; ?>
								<br>
								<hr>
